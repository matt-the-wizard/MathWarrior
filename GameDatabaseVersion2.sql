...
INSERT INTO [Players] ([PlayerID], [PlayerName], [MaximumHealth], [HealthPoints], [Strength], [Score], [Password]) VALUES (1, 'matt-the-wizard', 100, 100, 5, 0, 'Kyungheetkd99#');
...
INSERT INTO [Monsters] ([MID], [MonsterName], [MonsterDescription], [MonsterStrength], [MonsterHealth], [MonsterAttackDescription]) VALUES (1, 'Cheerleader Ghost Captain', 'The captain of the cheerleading squad. Beware her ferocious pom poms chained with metal spikes. ', 8, 10, 'The spiked pom poms strike you hard against the head. ');
INSERT INTO [Monsters] ([MID], [MonsterName], [MonsterDescription], [MonsterStrength], [MonsterHealth], [MonsterAttackDescription]) VALUES (2, 'Principle Goo Monster ', 'He ozzes with green goo and slimes everything he touches. Beware his toxicity!', 10, 15, 'Green goo is thrown at you hitting you in the face!');
INSERT INTO [Monsters] ([MID], [MonsterName], [MonsterDescription], [MonsterStrength], [MonsterHealth], [MonsterAttackDescription]) VALUES (3, 'Sassy Substitute Teacher Zombie', 'She wears high heels and laughs hysterically like a mad woman. Green goo covers her once beautiful red dress. ', 9, 11, 'High heels strike you in the rear!');
INSERT INTO [Monsters] ([MID], [MonsterName], [MonsterDescription], [MonsterStrength], [MonsterHealth], [MonsterAttackDescription]) VALUES (4, 'Gym Coatch Frankenstein', 'The large menacing frankenstein bores down at you with red glowing eyes and huge monstrous green hands.', 12, 12, 'Large green hands grab you and squeeze the breath out of you. ');
INSERT INTO [Monsters] ([MID], [MonsterName], [MonsterDescription], [MonsterStrength], [MonsterHealth], [MonsterAttackDescription]) VALUES (5, 'Cafeteria Pumpkin Monster', 'A large pumpkin monster mutated from zombie goo in the cafeteria. He opens his mouth and you see little pumpkin minions dancing around inside his mouth.', 6, 7,'A mini pumpkin is thrown at you at a very fast speed. ');
INSERT INTO [Monsters] ([MID], [MonsterName], [MonsterDescription], [MonsterStrength], [MonsterHealth], [MonsterAttackDescription]) VALUES (6, 'Zombie Nurse', 'The school nurse turned into a moaning zombie! Beware her medecinal needles full of green goo!', 5, 8, 'The nurse injects green goo into your arm!');
INSERT INTO [Monsters] ([MID], [MonsterName], [MonsterDescription], [MonsterStrength], [MonsterHealth], [MonsterAttackDescription]) VALUES (7, 'Ghost Bully', 'The school bully turned into a ghost! He hallows at you in a wailing voice!', 4, 10,  'The ghost hallows a deadly wind that sweeps you off your feet. ');
INSERT INTO [Monsters] ([MID], [MonsterName], [MonsterDescription], [MonsterStrength], [MonsterHealth], [MonsterAttackDescription]) VALUES (8, 'Mad Science Teacher', 'The chemistry professor has turned into a mad scientist! His hair has frizzed out everywhere and he holds flasks of green goo boiling and producing an odd odor. ', 6, 5, 'The scientist hurls a flask at you exploding green goo all over your body. ');
INSERT INTO [Monsters] ([MID], [MonsterName], [MonsterDescription], [MonsterStrength], [MonsterHealth], [MonsterAttackDescription]) VALUES (9, 'Rampaging Math Tutor', 'The math tutor has gone out of control and is running around the room destroying everything with his textbook! Beware his giant Calculus book!', 9, 8,  'The math tutor swings his Calculus book at you dealing a deadly blow!');
INSERT INTO [Monsters] ([MID], [MonsterName], [MonsterDescription], [MonsterStrength], [MonsterHealth], [MonsterAttackDescription]) VALUES (10, 'Dead Lunch Ladies', 'The lunch ladies of the cafeteria are zombified and spray green goo from their mouths. ', 8, 13,  'The lunch ladies spray green goo at you. ');
INSERT INTO [Monsters] ([MID], [MonsterName], [MonsterDescription], [MonsterStrength], [MonsterHealth], [MonsterAttackDescription]) VALUES (11, 'Pumpkin Witch', 'A witch riding a flying pumpkin. She is cloaked in black with a large pointy hat. Her hand holds a green flame, beware! ', 7, 10, 'The witch hurls a ball of green flame at you burning your skin.');
...
INSERT INTO [Puzzles] ([PID], [PuzzleDescription], [PuzzleHint], [PuzzleTerminator], [PuzzleSolvedMessage]) VALUES (35, 'There is no light and you cannot see. There is a lantern lying on the ground with matches next too it covered in goo. Maybe the matches can be lit in the lantnern.', 'Try using "light" with what you are trying to light.', 'light matches', 'The matches light the lantern and you can now see the way!');
INSERT INTO [Puzzles] ([PID], [PuzzleDescription], [PuzzleHint], [PuzzleTerminator], [PuzzleSolvedMessage]) VALUES (36, 'OH NO! Your foot triggered a rope trap and are snagged up into the air. Scissors are laying on the ground below and you think you can reach them with your fingertips. ', 'Try using "grab" with what you are trying to grab.', 'grab scissors', 'You grabbed the scissors and cut the rope. You fall with a steady landing but seem ok. The room is now cleared!');
INSERT INTO [Puzzles] ([PID], [PuzzleDescription], [PuzzleHint], [PuzzleTerminator], [PuzzleSolvedMessage]) VALUES (37, 'As you journey further into the room, a poisonous gas is released and you are losing your breadth. A gas mask is lying on a table, if only you could reach the gas mask. ', 'Try using "reach" with what you are trying to reach.', 'reach mask', 'You reached the gas mask and were able to breath. The fumes dissipated and now the room is clear.');
INSERT INTO [Puzzles] ([PID], [PuzzleDescription], [PuzzleHint], [PuzzleTerminator], [PuzzleSolvedMessage]) VALUES (38, 'The room has a blockade and you must climb over it to pass. A ladder is set aside, maybe if you could use the ladder. ', 'Try using "use" with what you are trying to use.', 'use ladder', 'You put the ladder against the rubbage and climbed over the blockade. You can now journey forward.');
INSERT INTO [Puzzles] ([PID], [PuzzleDescription], [PuzzleHint], [PuzzleTerminator], [PuzzleSolvedMessage]) VALUES (39, 'You come across a massive puddle of green goo with a plank sticking out of it. You need to pass, but how? Try using the plank to cross. ', 'Try using "use" with what you are trying to use.', 'use plank', 'You maneuver the plank out of the puddle and place it just right to fit on each side of the puddle. You can now pass!');
INSERT INTO [Puzzles] ([PID], [PuzzleDescription], [PuzzleHint], [PuzzleTerminator], [PuzzleSolvedMessage]) VALUES (40, 'As you journey further, you stumble and fall. Your leg is cut, and you need bandages. Try tearing your shirt to use as a bandage. ', 'Try using "tear" with what you are trying to tear.', 'tear shirt', 'You tear your shirt and use it as a bandage for your cut. You can now walk and venture on.');

INSERT INTO [Puzzles] ([PID], [PuzzleDescription], [PuzzleHint], [PuzzleTerminator], [PuzzleSolvedMessage]) VALUES (41, 'A dark spell is triggered, and you are paralyzed by fear. You cannot move and must answer the riddle to break the spell. Riddle: 30 white horses on a red hill. First they chump, then they stump, then they stand still.', 'What do you use to eat your food?', 'teeth', 'You solve the riddle and the dark spell is lifted! You can now venture forward. ');

INSERT INTO [Puzzles] ([PID], [PuzzleDescription], [PuzzleHint], [PuzzleTerminator], [PuzzleSolvedMessage]) VALUES (42, 'A dark spell is triggered, and you are paralyzed by fear. You cannot move and must answer the riddle to break the spell. Riddle: I have oceanless seas, sandless deserts, heightless mountains, and grassless lands. What am I?', 'What do you use to look at geography?', 'map', 'You solve the riddle and the dark spell is lifted! You can now venture forward. ');

INSERT INTO [Puzzles] ([PID], [PuzzleDescription], [PuzzleHint], [PuzzleTerminator], [PuzzleSolvedMessage]) VALUES (43, 'A dark spell is triggered, and you are paralyzed by fear. You cannot move and must answer the riddle to break the spell. Riddle: This thing all things devours. Birds, beasts, trees, flowers. Gnaws iron, bites steel. Grinds hard stones to meal. Slays king, ruins town, and beats mountain down.', 'What never stops?', 'time', 'You solve the riddle and the dark spell is lifted! You can now venture forward. ');

INSERT INTO [Puzzles] ([PID], [PuzzleDescription], [PuzzleHint], [PuzzleTerminator], [PuzzleSolvedMessage]) VALUES (44, 'A dark spell is triggered, and you are paralyzed by fear. You cannot move and must answer the riddle to break the spell. Riddle: It cannot be seen, cannot be felt,Cannot be heard, cannot be smelt.It lies behind stars and under hills,And empty holes it fills.It comes out first and follows after, Ends life, kills laughter. ', 'Opposite of light', 'dark', 'You solve the riddle and the dark spell is lifted! You can now venture forward. ');
...
INSERT INTO [Items] ([ItemID], [ItemName], [Type], [ItemDescription], [Value]) VALUES (20, 'Heavy Textbook', 'WEAPON', 'Equip this item to increase your strenth in battle.', 2);
INSERT INTO [Items] ([ItemID], [ItemName], [Type], [ItemDescription], [Value]) VALUES (21, 'Mountain Dew', 'ITEM', 'Use this item to heal your character''s current health points.', 25);
INSERT INTO [Items] ([ItemID], [ItemName], [Type], [ItemDescription], [Value]) VALUES (22, 'Trash Can Lid', 'ARMOR', 'Equip this item to increase your maximum hp amount to endure more hits in combat. ', 10);
INSERT INTO [Items] ([ItemID], [ItemName], [Type], [ItemDescription], [Value]) VALUES (23, 'Coffee', 'ITEM', 'Use this item to heal your character''s current health points.', 14);
INSERT INTO [Items] ([ItemID], [ItemName], [Type], [ItemDescription], [Value]) VALUES (24, 'Lunch Tray', 'WEAPON', 'Equip this item to increase your strenth in battle.', 3);
INSERT INTO [Items] ([ItemID], [ItemName], [Type], [ItemDescription], [Value]) VALUES (25, 'Beer', 'ITEM', 'Use this item to heal your character''s current health points.', 12);
INSERT INTO [Items] ([ItemID], [ItemName], [Type], [ItemDescription], [Value]) VALUES (26, 'Football Shoulder Pads', 'ARMOR', 'Equip this item to increase your maximum hp amount to endure more hits in combat. ', 8);
INSERT INTO [Items] ([ItemID], [ItemName], [Type], [ItemDescription], [Value]) VALUES (27, 'Skateboard', 'WEAPON', 'Equip this item to increase your strenth in battle.', 2);
INSERT INTO [Items] ([ItemID], [ItemName], [Type], [ItemDescription], [Value]) VALUES (28, 'Work Boots', 'ARMOR', 'Equip this item to increase your maximum hp amount to endure more hits in combat. ', 12);
INSERT INTO [Items] ([ItemID], [ItemName], [Type], [ItemDescription], [Value]) VALUES (29, 'Coke', 'ITEM', 'Use this item to heal your character''s current health points.', 20);
INSERT INTO [Items] ([ItemID], [ItemName], [Type], [ItemDescription], [Value]) VALUES (30, 'Red Bull', 'ITEM', 'Use this item to heal your character''s current health points.', 20);
